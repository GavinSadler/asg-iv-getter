...
################################################################################
## Form generated from reading UI file 'main_windowwXFspm.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sm_meta_time_data.setObjectName(u"sm_meta_time_data")
        ...
        self.sm_param_sweep_end.setDecimals(9)
        self.sm_param_sweep_end.setMinimum(-1100.000000000000000)
        self.sm_param_sweep_end.setMaximum(1100.000000000000000)
        ...
        self.sm_param_sweep_start.setDecimals(9)
        self.sm_param_sweep_start.setMinimum(-1100.000000000000000)
        self.sm_param_sweep_start.setMaximum(1100.000000000000000)
        ...
        self.sm_param_sweep_step.setDecimals(9)
        self.sm_param_sweep_step.setMinimum(-1100.000000000000000)
        self.sm_param_sweep_step.setMaximum(1100.000000000000000)
        ...
        self.sm_sweep_smu_select.setObjectName(u"sm_sweep_smu_select")
        ...
        self.sm_param_sweep_compliance.setDecimals(9)
        ...
        self.sm_param_repeat_sweep = QRadioButton(self.groupBox_6)
        self.sm_param_repeat_sweep.setObjectName(u"sm_param_repeat_sweep")
        self.sm_param_repeat_sweep.setChecked(True)

        self.gridLayout_6.addWidget(self.sm_param_repeat_sweep, 3, 1, 1, 1)
        ...
        self.sm_param_sweep_then_step = QRadioButton(self.groupBox_6)
        self.sm_param_sweep_then_step.setObjectName(u"sm_param_sweep_then_step")
        self.sm_param_sweep_then_step.setChecked(False)

        self.gridLayout_6.addWidget(self.sm_param_sweep_then_step, 3, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.sm_param_pause_between_sweeps, 2, 1, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.sm_param_pause_between_measurements, 1, 1, 1, 2)

        self.sm_param_number_of_tests = QSpinBox(self.groupBox_6)
        self.sm_param_number_of_tests.setObjectName(u"sm_param_number_of_tests")
        self.sm_param_number_of_tests.setMinimum(1)
        ...
        self.gridLayout_6.addWidget(self.sm_param_number_of_tests, 0, 1, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.sm_run_full_measurement, 4, 0, 1, 3)
        ...
        self.sm_param_constant_start.setObjectName(u"sm_param_constant_start")
        self.sm_param_constant_start.setDecimals(9)
        self.sm_param_constant_start.setMinimum(-1100.000000000000000)
        self.sm_param_constant_start.setMaximum(1100.000000000000000)
        ...
        self.sm_constant_smu_select.setObjectName(u"sm_constant_smu_select")
        ...
        self.sm_param_constant_compliance.setDecimals(9)
        ...
        self.sm_param_constant_step.setObjectName(u"sm_param_constant_step")
        self.sm_param_constant_step.setDecimals(9)
        self.sm_param_constant_step.setMinimum(-1100.000000000000000)
        self.sm_param_constant_step.setMaximum(1100.000000000000000)
        ...
        self.sm_param_constant_end.setObjectName(u"sm_param_constant_end")
        self.sm_param_constant_end.setDecimals(9)
        self.sm_param_constant_end.setMinimum(-1100.000000000000000)
        self.sm_param_constant_end.setMaximum(1100.000000000000000)
        ...
        self.ds_meta_time_data.setObjectName(u"ds_meta_time_data")
        ...
        self.ds_smu_select_1.setObjectName(u"ds_smu_select_1")
        ...
        self.ds_smu_select_2.setObjectName(u"ds_smu_select_2")
        ...
        self.tab_data_view.setObjectName(u"tab_data_view")
        ...
        self.gridLayout_7.addWidget(self.groupBox_10, 3, 4, 1, 2)

        self.label_19 = QLabel(self.tab_data_view)
        ...
        self.data_smu_select_2 = QComboBox(self.tab_data_view)
        self.data_smu_select_2.setObjectName(u"data_smu_select_2")

        self.gridLayout_7.addWidget(self.data_smu_select_2, 2, 5, 1, 1)

        self.label_20 = QLabel(self.tab_data_view)
        ...
        self.data_smu_select_1 = QComboBox(self.tab_data_view)
        self.data_smu_select_1.setObjectName(u"data_smu_select_1")

        self.gridLayout_7.addWidget(self.data_smu_select_1, 2, 3, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Wafer #:", None))
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Step of Process:", None))
        self.sm_meta_time_data.setText(QCoreApplication.translate("MainWindow", u"Include time data?", None))
        ...
        self.sm_sweep_smu_select.setItemText(0, QCoreApplication.translate("MainWindow", u"Simulated", None))
        ...
        self.sm_param_sweep_compliance.setSuffix(QCoreApplication.translate("MainWindow", u" mA", None))
        ...
        self.sm_right_plot_settings.setText(QCoreApplication.translate("MainWindow", u"Right Plot Settings", None))
        self.groupBox_6.setTitle(QCoreApplication.translate("MainWindow", u"Full Measurement", None))
        self.sm_param_repeat_sweep.setText(QCoreApplication.translate("MainWindow", u"Repeat Sweep", None))
        self.label_18.setText(QCoreApplication.translate("MainWindow", u"Multiple Test Order:", None))
        ...
        self.label_22.setText(QCoreApplication.translate("MainWindow", u"Number of Tests:", None))
        self.sm_param_sweep_then_step.setText(QCoreApplication.translate("MainWindow", u"Sweep and Step", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", u"Constant Step Parameters", None))
        self.sm_param_constant_voltage.setText(QCoreApplication.translate("MainWindow", u"Voltage", None))
        self.sm_param_constant_start.setSuffix(QCoreApplication.translate("MainWindow", u" V", None))
        self.sm_constant_smu_select.setItemText(0, QCoreApplication.translate("MainWindow", u"Simulated", None))

        self.sm_param_constant_compliance.setSuffix(QCoreApplication.translate("MainWindow", u" mA", None))
        ...
        self.sm_param_constant_step.setSuffix(QCoreApplication.translate("MainWindow", u" V", None))
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"Step", None))
        self.sm_param_constant_end.setSuffix(QCoreApplication.translate("MainWindow", u" V", None))
        self.label_16.setText(QCoreApplication.translate("MainWindow", u"End", None))
        ...
        self.label_31.setText(QCoreApplication.translate("MainWindow", u"Wafer #:", None))
        ...
        self.ds_meta_time_data.setText(QCoreApplication.translate("MainWindow", u"Include time data?", None))
        ...
        self.ds_smu_select_1.setItemText(0, QCoreApplication.translate("MainWindow", u"Simulated", None))

        self.label_55.setText(QCoreApplication.translate("MainWindow", u"Mode:", None))
        self.ds_param_compliance_1.setSuffix(QCoreApplication.translate("MainWindow", u" mA", None))
        ...
        self.ds_smu_select_2.setItemText(0, QCoreApplication.translate("MainWindow", u"Simulated", None))

        self.label_71.setText(QCoreApplication.translate("MainWindow", u"Mode:", None))
        self.ds_param_compliance_2.setSuffix(QCoreApplication.translate("MainWindow", u" mA", None))
        ...
        self.label_19.setText(QCoreApplication.translate("MainWindow", u"SMU 1 Label:", None))
        self.label_20.setText(QCoreApplication.translate("MainWindow", u"SMU 2 Label:", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_data_view), QCoreApplication.translate("MainWindow", u"Data", None))
