# Theme taken from DearPyGui_Ext repo, specifically:
...
def create_theme_imgui_light() -> Union[str, int]:
    ...
    with dpg.theme() as theme_id:
        ...
        # Make disabled buttons look grey
        with dpg.theme_component(dpg.mvButton, enabled_state=False):
            dpg.add_theme_color(dpg.mvThemeCol_Button, [163, 163, 163, 255])  # Normal state
            dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, [163, 163, 163, 255])  # Hover state
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, [163, 163, 163, 255])  # Active state
            dpg.add_theme_color(dpg.mvThemeCol_Text, [83, 83, 83, 255])
