...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def get_sweep_parameters(self, quick_measurement=False):
        ...
        return SweepParameters(
            ...
            self.sm_param_constant_start.value() * constant_multiplier,
            self.sm_param_constant_step.value() * constant_multiplier,
            (self.sm_param_constant_end.value() if not quick_measurement else self.sm_param_constant_start.value()) * constant_multiplier,
