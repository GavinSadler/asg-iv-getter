...
class Dataset:
    ...
    def __init__(self, metadada: Dict[str, str] | None = None, write_time=True, increment_color_angle=True):
        ...
        self.color = QtGui.QColor.fromHsv(Dataset._color_angle, 255, int(0.8 * 255))
    ...
    def copy(self):
        ...
        d_new.constant_supply_value = self.constant_supply_value
